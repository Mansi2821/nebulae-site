...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-4 sm:top-6 left-4 right-4 z-50">
      <motion.nav
        ...
        <div className="hidden md:block">
          <Link href="/lets-talk">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-gradient-to-r from-[#a259ff] via-[#b75cff] to-[#57c1eb] text-white px-4 py-2 lg:px-6 lg:py-2.5 rounded-lg font-medium shadow-md transition-all duration-300 hover:shadow-lg hover:opacity-90"
              style={{
